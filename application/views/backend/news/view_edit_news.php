    ...
    <div id="content">
      ...
      <div class="container-fluid">
        ...
        <div class="card shadow mb-4 col-lg-8 mx-auto">
          ...
          <div class="card-body">
            <form class="user" action="<?= base_url('index.php/news/edit_news/'.$news->ID_Berita) ?>" method="post" id="editNews" enctype="multipart/form-data">
              <div class="form-group row">
                <div class="col-sm-12 mb-3">
                  <input type="text" class="form-control form-control-user" id="title" name="title" placeholder="Judul berita" value="<?= $news->Title ?>">
                </div>
                <div class="col-sm-12 mb-3">
                  <img class="img-preview img-fluid mb-3" src="<?= base_url('uploads/'.$news->Image) ?>" id="frame" style="max-height: 500px; overflow:hidden; display: block;">
                ...
                <div class="col-sm-12 mb-3">
                  <input id="berita_post" type="hidden" name="berita_post" value="<?= $news->Berita_Post ?>">
                  <trix-editor input="berita_post" id="berita_post"></trix-editor>
                </div>
                <div class="col-sm-12 mb-3">
                  <input type="date" class="form-control form-control-user" id="created_at" name="created_at" placeholder="Tanggal dibuat" value="<?php  $date = new DateTime($news->Created_At); echo $date->format('Y-m-d'); ?>">
                </div>
              </div>
